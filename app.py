...
if st.session_state.step >= 2 and st.session_state.ai_data:
    ...
    st.markdown("""
    <div class="card" style="border-color:#00000066;margin-top:1rem">
        ...
        <div style="display:flex;gap:1rem;flex-wrap:wrap;margin-bottom:.6rem">
            ...
            <span style="background:#00000022;color:#cc3d1f;padding:.2rem .7rem;border-radius:20px;font-size:11px;font-weight:600">Structured Coaching</span>
            ...
            <span style="background:#00000022;color:#cc3d1f;padding:.2rem .7rem;border-radius:20px;font-size:11px;font-weight:600">Limited Spots</span>
        </div>
