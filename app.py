...
.card {
    ...
    transition: border-color .2s; box-shadow: 0 2px 12px rgba(212,167,106,0.1);
}
...
.stButton > button:hover { transform: translateY(-2px) !important; box-shadow: 0 8px 25px rgba(212,167,106,0.4) !important; }
