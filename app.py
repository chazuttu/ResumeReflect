...
<div class="reviews-grid">
    ...
    <div class="review-card">
        <div class="review-stars">★★★★★</div>
        <div class="review-body">"Used ResumeReflect for my US job search. My interview rate went from 5% to 32% in just two weeks. Best $10 I ever spent!"</div>
        <div class="review-name">James M.</div>
        <div class="review-role">Full Stack Developer · San Francisco, USA</div>
    </div>
    <div class="review-card">
        <div class="review-stars">★★★★★</div>
        <div class="review-body">"Coming from India, I was worried about ATS compliance for US companies. This tool gave me the confidence to apply. Got 3 offers!"</div>
        <div class="review-name">Sarah J.</div>
        <div class="review-role">Product Manager · New York, USA</div>
    </div>
    <div class="review-card">
        <div class="review-stars">★★★★☆</div>
        <div class="review-body">"Brilliant tool for international applicants. Helped me understand UK recruitment standards. Already in final rounds at 2 companies."</div>
        <div class="review-name">Emma L.</div>
        <div class="review-role">Data Scientist · London, UK</div>
    </div>
    <div class="review-card">
        <div class="review-stars">★★★★★</div>
        <div class="review-body">"As someone relocating to Canada, this helped immensely with tailoring my resume for North American standards. Landed my dream job!"</div>
        <div class="review-name">Michael T.</div>
        <div class="review-role">Software Engineer · Toronto, Canada</div>
    </div>
</div>
""", unsafe_allow_html=True)
