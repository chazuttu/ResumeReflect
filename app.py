...
.badge {
    ...
    background: linear-gradient(135deg,#d4af3722,#b8860b22);
...
.hero h1 {
    ...
    background: linear-gradient(135deg,#d4af37 30%,#ffd700);
...
.stButton > button:hover { transform: translateY(-2px) !important; box-shadow: 0 8px 25px #d4af3744 !important; }
...
.stDownloadButton > button:hover { transform: translateY(-2px) !important; box-shadow: 0 8px 25px #d4af3744 !important; }
...
.pay-btn {
    display:block; background:linear-gradient(135deg,#8b6914,#b8860b);
...
.pay-btn:hover { box-shadow:0 5px 18px #d4af3744; transform:translateY(-1px); }
...
.reviews-grid { display:grid; grid-template-columns:1fr 1fr; gap:.7rem; margin:1rem 0 1.5rem; }
.review-card {
    background:var(--card); border:1px solid var(--border);
    border-radius:12px; padding:0.7rem 0.8rem;
    box-shadow:0 2px 10px #f5c51812; transition: border-color .2s;
}
.review-card:hover { border-color:#d4af3766; }
.review-stars { color:#d4af37; font-size:14px; margin-bottom:0.3rem; letter-spacing:0.5px; }
.review-body { font-size:12px; color:var(--text); line-height:1.5; margin-bottom:0.4rem; font-style:italic; }
.review-name { font-weight:700; font-size:11px; color:var(--accent); }
.review-role { font-size:10px; color:var(--muted); margin-top:0px; }
.review-form-card {
    background:var(--card); border:1px solid var(--border);
