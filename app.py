...
if st.session_state.step >= 2 and st.session_state.ai_data:
    ...
    <div class="card" style="border-color:#00e5a044;margin-top:1rem">
        ...
        <div style="display:flex;gap:1rem;flex-wrap:wrap;margin-bottom:.6rem">
            <span style="background:#00e5a022;color:#00e5a0;padding:.2rem .7rem;border-radius:20px;font-size:11px;font-weight:600">$149 / 6 months</span>
    ...
    if st.button("🔔 Notify Me — 3-Month Coaching", key="mentorship_notify", use_container_width=True):
        log_payment_interest("6-Month Coaching $149", st.session_state.email or "")
    ...
    with c2:
        plan = st.selectbox("Plan", ["Basic $5", "Pro $10", "Premium $20"], label_visibility="collapsed")
