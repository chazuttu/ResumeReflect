...
if st.session_state.step >= 2 and st.session_state.ai_data:
    ...
    <div class="card" style="border-color:#f59e0b44;margin-top:.5rem">
        ...
        <div style="display:flex;gap:1rem;flex-wrap:wrap;margin-bottom:.6rem">
            <span style="background:#f59e0b22;color:#f59e0b;padding:.2rem .7rem;border-radius:20px;font-size:11px;font-weight:600">₹399 / session</span>
            <span style="background:#667eea22;color:#667eea;padding:.2rem .7rem;border-radius:20px;font-size:11px;font-weight:600">$5 USD available</span>
    ...
    if st.button("🔔 Notify Me — Mock Interview", key="mock_interview_notify", use_container_width=True):
        log_payment_interest("Mock Interview ₹399", st.session_state.email or "")
    ...
    <div class="card" style="border-color:#00e5a044;margin-top:1rem">
        ...
        <div style="display:flex;gap:1rem;flex-wrap:wrap;margin-bottom:.6rem">
            <span style="background:#00e5a022;color:#00e5a0;padding:.2rem .7rem;border-radius:20px;font-size:11px;font-weight:600">₹4,999 / 6 months</span>
            <span style="background:#667eea22;color:#667eea;padding:.2rem .7rem;border-radius:20px;font-size:11px;font-weight:600">$60 USD available</span>
    ...
    if st.button("🔔 Notify Me — 6-Month Mentorship", key="mentorship_notify", use_container_width=True):
        log_payment_interest("6-Month Mentorship ₹4,999", st.session_state.email or "")
